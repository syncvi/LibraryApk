...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == NEW_BOOK_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            editedBook = null;
            Snackbar.make(findViewById(R.id.coordinator_layout), getString(R.string.edited_book), Snackbar.LENGTH_LONG).show();
        }
        else {
    ...
    private class BookHolder extends RecyclerView.ViewHolder{
        ...
        public BookHolder(LayoutInflater inflater, ViewGroup parent){
            ...
            bookItem.setOnLongClickListener(v -> {
                ...
                Snackbar.make(findViewById(R.id.coordinator_layout),getString(R.string.deleted_book), Snackbar.LENGTH_LONG).show();
                return true;
            });
